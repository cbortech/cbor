...
// `h`, `b64` are core CDN syntax (not extensions, cannot be disabled), and
// `bignum` / `cbordata` are core RFC 8949 data-model features always active
// regardless of `builtinExtensions` — none of these are listed here.
